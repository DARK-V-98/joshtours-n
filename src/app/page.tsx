...
function FeaturedCars() {
  ...
  const [featured, ...rest] = featuredCars;
    ...
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          <div className="space-y-3">
            ...
            <p className="text-muted-foreground max-w-lg">
              Handpicked vehicles maintained to the highest standards for your comfort and safety across Sri Lanka.
            </p>
          </div>
          <Button variant="heroOutline" size="lg" asChild className="self-start md:self-auto flex-shrink-0">
            <Link href="/cars" className="flex items-center gap-2">
              View All Vehicles
        ...
        {loading ? (
          ...
          <p className="text-center text-muted-foreground py-16">No featured vehicles available right now.</p>
        ) : featuredCars.length === 1 ? (
          <div className="max-w-2xl mx-auto">
            <CarCard car={featuredCars[0]} featured />
          </div>
          ...
          /* Asymmetric: big featured left, two stacked right */
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            {/* Featured large card */}
        ...
        <div className="mt-14 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={label} className="text-center p-5 rounded-2xl bg-card border border-border">
              <p className="font-display text-3xl font-bold text-gradient-gold">{value}</p>
...
const localBusinessJsonLd = {
  ...
  "@type": "LocalBusiness",
  name: "Josh Tours",
  description: "Quality car rental services in Sri Lanka — sedans, SUVs, vans with full insurance and 24/7 support.",
  url: "https://joshtours.lk",
  telephone: "+94701209694",
  email: "joshtoursbe@gmail.com",
  address: {
    "@type": "PostalAddress",
    streetAddress: "68/2A, Welikadamulla Road, Mabola",
  ...
  priceRange: "$$",
  image: "https://joshtours.lk/rtm.png",
  sameAs: [],
};
