...
import { Calendar as CalendarIcon, Car as CarIcon, CheckCircle, Loader2 } from 'lucide-react';
...
const manualBookingSchema = z
  .object({
    ...
    customerNicOrPassport: z.string().min(1, "NIC or passport number is required."),
  ...
  async function onSubmit(values: ManualBookingValues) {
    ...
    try {
        ...
        toast({
            ...
            description: "Failed to create the booking. Please check your inputs and try again.",
        });
    }
  }
  ...
  return (
    <div className="p-6">
      <div className="max-w-3xl mx-auto">
        <div className="mb-6">
          <h1 className="text-3xl font-display font-bold">Manual Booking Entry</h1>
          <p className="text-muted-foreground mt-1">Record a new booking for a walk-in or phone customer.</p>
        </div>
          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                    control={form.control}
                    name="customerNicOrPassport"
                    render={({ field }) => (
                        <FormItem>
                        <FormLabel>NIC / Passport Number</FormLabel>
                        <FormControl>
                            <Input placeholder="e.g., 200012345678 or N1234567" {...field} />
                        </FormControl>
                        <FormMessage />
                        </FormItem>
                    )}
