      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Have a question or want to book a car? Send us a message.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField control={form.control} name="message" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Tell us about your rental needs..." {...field} rows={6} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
