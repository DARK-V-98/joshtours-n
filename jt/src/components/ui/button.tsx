  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-amber-500 to-orange-500 text-primary-foreground font-semibold shadow-[0_4px_30px_-5px_hsl(43_96%_56%_/_0.3)] hover:shadow-lg hover:-translate-y-1 active:translate-y-0",
        heroOutline: "border-2 border-primary bg-transparent text-primary hover:bg-primary hover:text-primary-foreground",
        gold: "bg-gradient-to-r from-amber-500 to-orange-500 text-primary-foreground shadow-[0_4px_30px_-5px_hsl(43_96%_56%_/_0.3)] hover:shadow-lg transition-all",
